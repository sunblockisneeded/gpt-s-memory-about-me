...
교육은 다양한 수준과 내용에 맞춘 '천재 모방 교육 구조'(이는 좀 밑에 내리다보면 있음)를 기반으로 해야 한다고 제안합니다. 이 방식이나 구조가 매우 어렵고 작은 교육 기관의 역량을 넘어선다는 점을 강조하며, 우선순위는 머신러닝이나 딥러닝 프레임워크같은 특정 작업이 아니라 초등 및 중학생들에게 수학을 가르치는 교육 구조를 개발하는 데 두어야 한다고 생각합니다. 
